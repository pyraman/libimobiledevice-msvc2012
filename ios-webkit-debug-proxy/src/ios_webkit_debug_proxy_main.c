...
#define PACKAGE_STRING				"ios-webkit-debug-proxy"
#define LIBIMOBILEDEVICE_VERSION	"1.2.0.2"
#define LIBPLIST_VERSION			"2.0.0"
struct iwdpm_struct {
  char *config;
  char *frontend;
  bool is_debug;
      ...
      case 'u':
        {
          ...
          regmatch_t *groups = (regmatch_t *)calloc(ngroups, sizeof(regmatch_t));
