...
void thread_once_plist(thread_once_t *once_control, void(*init_routine)(void))
{
...
//		thread_once_plist(&init_once, internal_plist_init);
//        break;
//    case DLL_PROCESS_DETACH:
//		thread_once_plist(&deinit_once, internal_plist_deinit);
//        break;
//    default:
//        break;
//    }
